...
def cover():
    print """
     ...
     """
    runntek(GL+"        Dego Max ^_^...")
    time.sleep(1)
    print " "
    print RR+"  +============================================+"
    print GG+"  |••••••••   FUERZA BRUTA DG X BLAK  •••••••••|" 
    print RR+"  +============================================+"
    print WW+"  |            Create: Dego X BLACK            |"
    print GG+"  |            Facebook: Carlos Max            |"
    print WW+"  |            Youtube: Dego Max               |"
    print  Y+"  |            Instagram: Carlos_Max           |"
    print WW+"  |--------------------------------------------|"
    print GL+"  |NO NOS HACEMOS RESPONSABLE DEL MAL USO      |"
    print WW+"  |--------------------------------------------|"
    print RR+"  +============================================+"
